      ...
      <Container width="default">
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <Typography level="h1" className="mb-8">{t('page.title')}</Typography>
            ...
            <div className="space-y-6">
              <div>
                ...
                <Typography level="body-sm" tone="secondary">Istanbul, Turkey</Typography>
              </div>
              <div>
                <Typography level="overline" tone="tertiary" className="mb-1 block">
                  {t('info.email')}
          ...
          <div className="lg:col-span-3">
            {submitState === 'success' ? (
              <div className="border border-border p-8">
                <Typography level="h3" className="mb-3">{t('form.success')}</Typography>
