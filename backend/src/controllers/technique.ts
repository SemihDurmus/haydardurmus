...
import * as service from "../services/technique";
import { parsePagination, paginated } from "../utils/pagination";

// Same five thin handlers as the nationality controller, pointed at the
// technique service. HTTP glue only: read req.valid, call service, send.
